...
"""THE TOWER OF HANOI, a stack moving puzzile game."""
...
def main():
    ...
    integeres representing disks of different sizes, and the start of
    ...
    larger disk on top of a smaller disk and is an invalid configuration.
    The list [3, 1] is allowed since smaller disks
